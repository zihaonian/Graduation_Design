...
#define  SGP30_SCL_LOW    GPIO_ResetBits ( SGP30_SCL_GPIO_PORT, SGP30_SCL_GPIO_PIN )
#define  SGP30_SCL_HIGH    GPIO_SetBits ( SGP30_SCL_GPIO_PORT, SGP30_SCL_GPIO_PIN )

#define  SGP30_SDA_LOW    GPIO_ResetBits ( SGP30_SDA_GPIO_PORT, SGP30_SDA_GPIO_PIN )
#define  SGP30_SDA_HIGH    GPIO_SetBits ( SGP30_SDA_GPIO_PORT, SGP30_SDA_GPIO_PIN )
